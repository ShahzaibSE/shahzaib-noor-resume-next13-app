...
export default function Header() {
  return (
    <nav className="border-gray-200 bg-neutral-800 px-4 py-2.5 dark:bg-neutral-800 lg:px-6">
      ...
      <div className="container flex flex-shrink items-center">
        <div className="container flex flex-1 flex-shrink items-center justify-between">
          ...
          <div className="flex flex-grow px-2">
            <h1 className="md: text-xs; sm: text-xs; font-sans text-2xl font-bold text-white">
              Shahzaib Noor
            </h1>
          </div>
        </div>
